...
function Header() {
    ...
    return (
        ...
        <header>
            ...
            {/* navbar links */}
                <ul className="absolute w-full top-[100%] right-0 text-brand-600 pl-4 pb-8 pt-4 shadow-md shadow-brand-400 rounded-md transition duration-500 ease-in-out z-10 bg-brand-100 translate-x-[23rem] h-[100vh] md:hidden" ref={linkBoxRef}>
                ...
                <div className="cursor-pointer absolute top-14 right-10 lg:hidden" onClick={()=>{
                    ...
                    linkBoxRef.current.classList.toggle('translate-x-[23rem]');
                    }}>
